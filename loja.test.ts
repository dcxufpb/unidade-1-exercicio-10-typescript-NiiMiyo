...
test("Complemento vazio", () => {
	...
	expect(complementoVazio.dados_loja()).toBe(TEXTO_ESPERADO_SEM_COMPLEMENTO);
});
...
test("Observação vazia", () => {
	...
	expect(observacaoVazia.dados_loja()).toBe(TEXTO_ESPERADO_SEM_OBSERVACAO);
});
...
test("Número zero e complemento vazio", () => {
	...
	expect(numeroZeroComplementoVazio.dados_loja()).toBe(
...
test("Número zero, complemento e bairro vazios", () => {
	...
	expect(numeroZeroComplementoVazioBairroVazio.dados_loja()).toBe(
